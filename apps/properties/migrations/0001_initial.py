# Generated by Django 3.2.7 on 2023-05-07 15:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Enter Description', verbose_name='Description')),
                ('country', django_countries.fields.CountryField(default='ES', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Madrid', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='00000', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='123 Street', max_length=150, verbose_name='Street Address')),
                ...
                ('total_floors', models.IntegerField(default=1, verbose_name='Floors')),
                ...
                ('property_type', models.CharField(choices=[('House', 'House'), ('Apartment', 'Apartment'), ('Office', 'Office'), ('Warehouse', 'Warehouse'), ('Commercial', 'Commercial'), ('Other', 'Other')], default='House', max_length=50, verbose_name='Property Type')),
