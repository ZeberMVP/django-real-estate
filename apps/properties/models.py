...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(
        verbose_name=_("Description"), default="Enter Description"
    )
    country = CountryField(
        verbose_name=_("Country"), default="ES", blank_label="(Select Country)"
    )
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Madrid")
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="00000"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="123 Street"
    )
    ...
    total_floors = models.IntegerField(verbose_name=_("Floors"), default=1)
...
class PropertyViews(TimeStampedUUIDModel):
    ...
    def __str__(self):
        return f"Total views on - {self.property.title} is - {self.views} view(s)"
