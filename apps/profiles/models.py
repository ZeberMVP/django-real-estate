...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=("Phone Number"), max_length=30, default="+34612983465"
    )
    about_me = models.TextField(
        verbose_name=("About me"), default="say something about yourself"
    )
    ...
    country = CountryField(
        verbose_name=("Country"), default="ES", blank=False, null=False
    )
